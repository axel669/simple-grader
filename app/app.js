...
},{"core-js/library/fn/promise":13}],6:[function(require,module,exports){
...
},{"_process":1,"babel-runtime/core-js/object/create":2,"babel-runtime/core-js/object/set-prototype-of":4,"babel-runtime/core-js/promise":5,"babel-runtime/core-js/symbol":6}],10:[function(require,module,exports){
var $ = require('../../modules/$');
...
},{"../../modules/$.core":20,"../../modules/es6.object.set-prototype-of":68}],13:[function(require,module,exports){
require('../modules/es6.object.to-string');
require('../modules/es6.string.iterator');
require('../modules/web.dom.iterable');
require('../modules/es6.promise');
module.exports = require('../modules/$.core').Promise;
},{"../modules/$.core":20,"../modules/es6.object.to-string":69,"../modules/es6.promise":70,"../modules/es6.string.iterator":71,"../modules/web.dom.iterable":73}],14:[function(require,module,exports){
require('../../modules/es6.symbol');
require('../../modules/es6.object.to-string');
module.exports = require('../../modules/$.core').Symbol;
},{"../../modules/$.core":20,"../../modules/es6.object.to-string":69,"../../modules/es6.symbol":72}],15:[function(require,module,exports){
...
},{"./$.add-to-unscopables":16,"./$.iter-define":41,"./$.iter-step":43,"./$.iterators":44,"./$.to-iobject":62}],68:[function(require,module,exports){
// 19.1.3.19 Object.setPrototypeOf(O, proto)
var $export = require('./$.export');
$export($export.S, 'Object', {setPrototypeOf: require('./$.set-proto').set});
},{"./$.export":26,"./$.set-proto":53}],69:[function(require,module,exports){
...
},{"./$":45,"./$.a-function":15,"./$.an-object":17,"./$.classof":18,"./$.core":20,"./$.ctx":21,"./$.descriptors":23,"./$.export":26,"./$.for-of":28,"./$.global":30,"./$.is-object":38,"./$.iter-detect":42,"./$.library":47,"./$.microtask":48,"./$.redefine-all":50,"./$.same-value":52,"./$.set-proto":53,"./$.set-species":54,"./$.set-to-string-tag":55,"./$.species-constructor":57,"./$.strict-new":58,"./$.wks":65}],71:[function(require,module,exports){
'use strict';
...
},{"./$.iter-define":41,"./$.string-at":59}],72:[function(require,module,exports){
'use strict';
...
},{"./$":45,"./$.an-object":17,"./$.descriptors":23,"./$.enum-keys":25,"./$.export":26,"./$.fails":27,"./$.get-names":29,"./$.global":30,"./$.has":31,"./$.is-array":37,"./$.keyof":46,"./$.library":47,"./$.property-desc":49,"./$.redefine":51,"./$.set-to-string-tag":55,"./$.shared":56,"./$.to-iobject":62,"./$.uid":64,"./$.wks":65}],73:[function(require,module,exports){
require('./es6.array.iterator');
var Iterators = require('./$.iterators');
Iterators.NodeList = Iterators.HTMLCollection = Iterators.Array;
},{"./$.iterators":44,"./es6.array.iterator":67}],74:[function(require,module,exports){
"use strict";

var _regeneratorRuntime = require("babel-runtime/regenerator")["default"];

exports.__esModule = true;
var API_NAME = API.create("url goes here");
    ...
    demo: function demo() {
        return _regeneratorRuntime.async(function demo$(context$1$0) {
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    context$1$0.next = 2;
                    return _regeneratorRuntime.awrap(API_NAME.request("/test"));
...
},{"babel-runtime/regenerator":8}],75:[function(require,module,exports){
"use strict";
...
var _pluginsFirebase = require("plugins/firebase");

var _pluginsFirebase2 = _interopRequireDefault(_pluginsFirebase);
    ...
    componentDidMount: function componentDidMount() {
        return _regeneratorRuntime.async(function componentDidMount$(context$1$0) {
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    context$1$0.next = 2;
                    return _regeneratorRuntime.awrap(_pluginsFirebase2["default"].currentUser);

                case 2:
                    context$1$0.t0 = context$1$0.sent;

                    if (!(context$1$0.t0 === null)) {
                        context$1$0.next = 7;
                        break;
                    }
...
var Register = React.createClass({
    ...
    register: function register(_ref) {
        ...
        var userInfo;
        return _regeneratorRuntime.async(function register$(context$1$0) {
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    Dialog.spinner("Registering");
                    try {
                        userInfo = _pluginsFirebase2["default"].registerEmail(email, password);

                        console.log(userInfo);
                        chrono.trigger(16, function () {
                            return App.navigation.replace("/list");
                        });
                    } catch (e) {
                        console.error(e);
                    }
    ...
    render: function render() {
        return React.createElement(
            UI.Screen,
            { title: "Simple Grader", width: 325 },
            React.createElement(
                UI.Card,
                null,
                React.createElement(
                    UI.Form,
                    { submitText: "Register", onSubmit: this.register },
                    React.createElement(UI.TextInput, { formName: "email", inputType: "text", placeholder: "Email" }),
                    React.createElement(UI.TextInput, { formName: "password", inputType: "text", type: "password", placeholder: "Password" })
                )
            )
        );
    }
...
var List = React.createClass({
        ...
        return _regeneratorRuntime.async(function componentDidMount$(context$1$0) {
            while (1) switch (context$1$0.prev = context$1$0.next) {
                case 0:
                    ...
                    this.setState({
                        list: factotum.range(10, function (n) {
                            return { name: "Gradebook #" + n, "class": "ASTRO " + (350 + n), time: Date.now() };
                        })
                    });
    ...
    render: function render() {
        ...
        return React.createElement(
            UI.Screen,
            { title: "Simple Grader", scrollable: true },
            list === null ? "Loading Gradebooks" : React.createElement(
                UI.Flexbox,
                { colCount: 3, minWidth: 220, autopad: true },
                list.map(function (section) {
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            null,
                            "Time: ",
                            chrono(section.time).format("{hour/12}:{minute}")
                        ),
                        React.createElement(
                            UI.Flexbox,
                            { colCount: 2 },
                            React.createElement(UI.Button, { text: "Open", fill: true, flush: true }),
                            React.createElement(UI.Button, { text: "Delete", color: "red", fill: true, flush: true })
                        )
                    );
                })
            )
...
},{"babel-runtime/helpers/interop-require-default":7,"babel-runtime/regenerator":8,"datacenter":74,"plugins/firebase":76,"settings":77,"theme/default":78}],76:[function(require,module,exports){
"use strict";
...
exports["default"] = _Object$defineProperties({
    ...
    registerEmail: function registerEmail(email, password) {
    ...
    currentUser: {
        get: function get() {
            ...
            return new _Promise(function (resolve) {
                var changed = function changed(token) {
...
},{"babel-runtime/core-js/object/define-properties":3,"babel-runtime/core-js/promise":5}],77:[function(require,module,exports){
"use strict";
